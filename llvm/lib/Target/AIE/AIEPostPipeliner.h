...
class PostPipeliner {
  ...
  /// Verify latencies after register allocation by rebuilding the DAG
  /// with physical registers and checking scheduled cycles against computed
  /// earliest times. Returns true if verification passes.
  bool verifyLatenciesAfterRegAlloc();
